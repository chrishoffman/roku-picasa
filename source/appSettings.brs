...
Sub picasa_delink()
    ans=ShowDialog2Buttons("Deactivate Player","Remove link to you Picasa account?","Confirm","Cancel")
    if ans=0 then 
        oa = Oauth()
        oa.erase()
    end if
...
Sub picasa_about()
    ...
    screen.AddParagraph("The Picasa Web Albums Channel was developed by Chris Hoffman.  The channel is not affiliated with Google.  If you have any questions or comments, go to forums.roku.com and send a message directly to me.  My username is hoffmcs.")
